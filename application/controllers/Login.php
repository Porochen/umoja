...
{	
	...
	public function do_login() {
        ...
        if (!empty($user)) {
            ...
            $message['message'] = "<div class='alert alert-danger text-center'> L'utilisateur n'existe pas dans notre système !</div>";
        }
    ...
    public function recover()
 {
     ...
     if (!empty($user)) {
        ...
        $msg_mail = "Cher(e), ".$user['nom_membre']." ".$user['prenom_membre'].",Votre mot de passe vient d'etre modifié, Votre nouveau mot de passe actuel est :".$code."<br> Cordialement.";
        ...
        $data = array('response' => "success", 'message' =>"Votre mot de passe est modifié.Consultez votre boîte email");
     }else{
 ...
 public function admin_do_login() {
        ...
        if (!empty($user)) {
            ...
            $message = "<div class='alert alert-danger text-center'> L'utilisateur n'existe pas dans notre système !</div>";
