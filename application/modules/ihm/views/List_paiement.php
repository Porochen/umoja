...
<?php include VIEWPATH.'template/includes/admin_menu.php';?>
     ...
     <div>
        ...
        <div class="float-left" style="margin-left:15px"><a href="<?=base_url('ihm/Mode_paiement/Add')?>" class="btn btn-primary"><i class="fa fa-plus"></i>Nouveau</a></div>
         <?=$this->table->generate($paiement)?>
