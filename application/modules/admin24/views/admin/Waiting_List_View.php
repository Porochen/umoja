                ...
                <div class="row mt--5">
                        <div class="col-lg-4 col-xl-3">
                            ...
                            <div class="panel-heading p-4 text-center">
                                <h3 class=" text-center mb-2">Team Leader</h3>
                            ...
                            <div class=" userlist">
                                <div class="card-body text-center">
                                    <div class="userprofile mt-0">
                                        <div class="userpic"> 
                                            <center>
                                                   <img class="media-object rounded-circle thumb-sm" alt="Nina Nineza" src="<?= base_url()?>assets/img/jm_denis.jpg" style="width: 100px; height: 100px">
                                                  </center>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom-0 p-4">
                                  <?php $total=count($user_in_waiting);?>
                                    <h2 class="card-title"><?=$total;?> Membre(s)</h2>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          Voulez-vous activer <strong><em><?=$value['prenom_membre']?></em></strong>
        </h5>
        <button type="button" class="btn btn-close" data-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-footer">
        <form action="<?= base_url('admin/Admin/approuver_waiting_list')?>" method="post">
...
<?php } } else { ?>
                                  <tr>
                                    <td colspan="5">
                                      <center>
                                         <h5>AUCUNE DONNEE A AFFICHER.</h5>
                                      </center>
                                    </td>
                                  </tr>
<?php        } ?>
        ...
        function new_fire(){
          ...
          if (nom_membre!='' && prenom_membre!='' && email_membre!='' && tele_membre!='' && code!='') {
             $('[name="code"]').css('border-color','');
              $.ajax({
                url:'<?= base_url()?>admin/Admin/new_fire',
                type:'post',
                ...
                success:function(data){
                    ...
                    setInterval(function(){ 
                      ...
                      window.location.href='<?= base_url() ?>admin/Admin/Waiting_list';
