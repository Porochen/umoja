					...
					<div class="col-lg-3 col-md-12 col-sm-12">
						<div class="card">
							<div class="list-group list-group-transparent mb-0 mail-inbox">
								...
								<a href="<?=base_url('admin/Admin_Support/sent_message')?>" class="list-group-item list-group-item-action d-flex align-items-center active">
									<span class="icon mr-3">
...
<script>
   ...
   getList()
    ...
    function getList(){
       $.ajax({
        url: "<?=base_url('admin/Admin_Support/listing_sent/');?>",
        type: "POST",
        dataType: 'JSON',
      error:function() {
