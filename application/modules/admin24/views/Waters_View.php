            ...
            <div class="panel panel-default">
                <div class="panel-body p-t-0">
                    <div class="input-group">
                        <input type="text" onkeyup="getList(this.value,0)" autocomplete="off" id="search" name="example-input1-group2" class="form-control" placeholder="Recherche">
...
<script>
    function getList(critere="",page=0){
       ...
       $.ajax({
        url: "<?=base_url('admin/Waters/listing/');?>",
        type: "POST",
        dataType: 'JSON',
        ...
        // contentType: false,
        beforeSend:function () { 
              $('#get_waters').html("<br><div class='col-lg-12'><center><font style='font-size:46px'><i class='fa fa-46px fa-spin fa-spinner'></i><span class='sr-only'>Loading...</span></font></center></div>");
            },
      error:function() {
