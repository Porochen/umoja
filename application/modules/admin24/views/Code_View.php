...
<script>
    function getList(critere="",page=0){
       ...
       $.ajax({
        url: "<?=base_url('admin/Code_Verification/listing/');?>",
        type: "POST",
        ...
        // contentType: false,
        beforeSend:function () { 
              $('#get_code').html("<br><div class='col-lg-12'><center><font style='font-size:46px'><i class='fa fa-46px fa-spin fa-spinner'></i><span class='sr-only'>Loading...</span></font></center></div>");
            },
      error:function() {
          $('#get_code').html('<div class="alert alert-danger col-md-12"><h6 class="text-center">Error: reessayer encore ! </h6></div>');
      },
