...
<?php include VIEWPATH.'template/includes/admin_menu.php';?>
    ...
    <div class="main-panel">
     ...
     <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="card-title"><h3>Ajouter un administrateur<a href="<?=base_url('administrateurs/Administrateurs')?>" class="btn btn-primary btn-sm float-right text-white"><i class="fa fa-list"></i>Liste</a></h3></div>
          ...
          <form id="formadmin" onsubmit="return false;" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-6">
                ...
                <div class="form-group">
                  <label></label>
                  <button type="button" class="btn btn-primary mt-4 mt-sm-0 btn-icon-text" onclick="save()">
  ...
  function save(){
          ...
          if (nom!='' && prenom!='' && phone!='' && email!='') {
              ...
              $.ajax({
                ...
                url:'<?= base_url()?>administrateurs/Administrateurs/save',

                type:'post',
                dataType: "json",
                data:{nom:nom,prenom:prenom,email:email,phone:phone},
