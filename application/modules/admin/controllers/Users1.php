...

{
    ...
    $total_record=$this->Model->readRequeteOne('SELECT COUNT(*) AS total_record FROM membre m WHERE 1');
...
function updateData($id_membre){
		...
		$this->Model->update('membre',array('id_membre' => $id_membre),$data);
			...
			$data['message']='<div class="alert alert-success text-center" id ="message">La modification réussi avec succès.</div>';
