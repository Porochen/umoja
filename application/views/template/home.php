					...
					<div class="row mt--2 ">
					  <div class="col-md-8">
					    ...
					    <div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="card">
									<div class="card-body">
										<h3 class="mb-1">Network Analytics Report</h3>
										<p class="text-muted mb-5">Report of your team network status and health level.</p>
										<div class="row mt-4">

											<div class="col-md-4 dash-1">
												<h6 class="mb-1"><span class="dot-label bg-primary"></span>1st Tier</h6>
												<h2 class="mb-1">100%</h2>
												<span class=" mb-0 text-muted"><b>2</b> / 2 Members</span>
											</div>

											<div class="col-md-4 dash-1">
												<h6 class="mb-1"><span class="dot-label bg-secondary"></span>2nd Tier</h6>
												<h2 class="mb-1">100%</h2>
												<span class=" mb-0 text-muted"><b>4</b> / 4 Members</span>
											</div>

											<div class="col-md-4">
												<h6 class="mb-1"><span class="dot-label bg-danger"></span>3rd Tier</h6>
												<h2 class="mb-1">37.5%</h2>
												<span class=" mb-0 text-muted"><b>3</b> / 8 Members</span>
											</div>
										</div>
